...
- [x] **PRICE-08**: User can see a 24h price-change badge on the product detail page, alongside the existing 7d/30d badges
- [x] **PRICE-09**: User can see an all-time high/low price badge on the product detail page, covering the full range since data collection began
...
| PRICE-08 | Phase 9: 24h & All-Time Price Badges | Complete |
| PRICE-09 | Phase 9: 24h & All-Time Price Badges | Complete |
